...
//  private static void insert(MongoCollection<Document> collection, String title, String artist) {
//  Document document = new Document();
...
//
//  FindIterable<Document> documents = collection.find(eq("artist", "artist"));
//  for (Document d : documents) {
//      System.out.println(d.toJson());
//  }
//}
